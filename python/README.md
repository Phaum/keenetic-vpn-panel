...
Основная логика находится в `python/vpn_panel_server.py`. Установленная
Python-версия размещается в `/opt/share/keenetic-vpn-panel/python`.
...
```sh
/bin/sh -c "$(curl -fsSL https://raw.githubusercontent.com/Phaum/keenetic-vpn-panel/master/python/install/install.sh)"
```

Если `curl` нет:

```sh
/bin/sh -c "$(wget -O- https://raw.githubusercontent.com/Phaum/keenetic-vpn-panel/master/python/install/install.sh)"
```
...
- обновляет `opkg`
- ставит зависимости
- скачивает Python-версию в `/opt/share/keenetic-vpn-panel/python`
...
```sh
/bin/sh -c "$(curl -fsSL https://raw.githubusercontent.com/Phaum/keenetic-vpn-panel/master/python/install/update.sh)"
```
...
```sh
/bin/sh -c "$(curl -fsSL https://raw.githubusercontent.com/Phaum/keenetic-vpn-panel/master/python/install/uninstall.sh)"
```
